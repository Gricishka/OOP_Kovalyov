...
public class BouncingBallSimpleEx3 extends JPanel {
    ...
    private static final int N_OF_FILLED_RECTS = 10;
    private static final int N_OF_OUTLINED_RECTS = 10;
    private static final int N_OF_RECTS = 10;
    ...
    private static Rectangle[] components = new Rectangle[N_OF_RECTS + N_OF_OUTLINED_RECTS + N_OF_FILLED_RECTS];
    ...
    public void paintComponent(Graphics g) {
        ...
        for (Rectangle rectangle : components) {
            if (rectangle instanceof ColoredRect a) {
                a.setOutColor(Color.CYAN);
                a.setInColor(Color.GRAY);
                a.draw(g);
            } else if (rectangle instanceof DrawableRect a) {
                a.setOutColor(Color.ORANGE);
                a.draw(g);
            } else {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < components.length; i++) {
            ...
            } else if (i < N_OF_RECTS + N_OF_OUTLINED_RECTS) {
